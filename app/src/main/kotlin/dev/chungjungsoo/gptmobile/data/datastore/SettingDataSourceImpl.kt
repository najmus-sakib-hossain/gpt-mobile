...
class SettingDataSourceImpl @Inject constructor(
    ...
    private val apiStatusMap = mapOf(
        ...
        ApiType.OFFLINE_AI to booleanPreferencesKey("offline_ai_status")
    )
    private val apiUrlMap = mapOf(
        ...
        ApiType.OFFLINE_AI to stringPreferencesKey("offline_ai_url")
    )
    private val apiTokenMap = mapOf(
        ...
        ApiType.OFFLINE_AI to stringPreferencesKey("offline_ai_token")
    )
    private val apiModelMap = mapOf(
        ...
        ApiType.OFFLINE_AI to stringPreferencesKey("offline_ai_model")
    )
    private val apiTemperatureMap = mapOf(
        ...
        ApiType.OFFLINE_AI to floatPreferencesKey("offline_ai_temperature")
    )
    private val apiTopPMap = mapOf(
        ...
        ApiType.OFFLINE_AI to floatPreferencesKey("offline_ai_top_p")
    )
    private val apiSystemPromptMap = mapOf(
        ...
        ApiType.OFFLINE_AI to stringPreferencesKey("offline_ai_system_prompt")
    )
